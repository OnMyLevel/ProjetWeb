<template>
 <div> 
        ...
        <hr/>
        <h2>Les utilisateurs et visiteurs: </h2>
        du site internet peuvent mettre en place un hyperlien en direction de
        ce site, mais uniquement en direction de la page d’accueil, accessible à l’URL suivante : www.site-internet-qualite.fr, à condition que ce lien s’ouvre dans une nouvelle fenêtre. En particulier un lien vers une sous page (« lien profond ») est interdit, ainsi que l’ouverture du présent site au sein d’un cadre (« framing »), 
        sauf l'autorisation expresse et préalable de Natural-net.
        Pour toute demande d'autorisation ou d'information, veuillez
        nous contacter par email : contact@natural-net.fr. Des conditions spécifiques sont prévues pour la presse.
        ...
        <hr/>
        <h2>J´accepte :</h2> mes données personnelles soient utilisées pour être recontacté 
        par Natural-net à des fins commerciales *
        Les informations recueillies sur ce formulaire sont enregistrées dans un fichier informatisé par Natural net pour nos offres et démarches commerciales. 
        Elles sont conservées pendant 36 mois et sont destinées à :
        ...
        <hr/> 
         <h2>Actus Agence Web :</h2>
        Vous pouvez exercer ces droit en contactant : GETAVOCAT - DPO de Natural-net : Maître Christophe 
        LANDAT, 18 rue de la République 34000 Montpellier.
        Nous vous informons de l’existence de la liste d'opposition au 
        démarchage téléphonique « Bloctel », sur laquelle vous pouvez vous inscrire ici : https://conso.bloctel.fr/
